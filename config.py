...
class Config(object):
    ...
    # CHANGE: Changed to 0.5 following [some paper]
    ...
    # TODO: Compare loss wieghts
    LOSS_WEIGHTS = {
        "rpn_class_loss": 1., #2.
        "rpn_bbox_loss": 1., #0.1
        "mrcnn_class_loss": 1., #2.
        "mrcnn_bbox_loss": 1., #0.5
        "mrcnn_mask_loss": 1. #1.
    }
    ...
    def __init__(self):
        ...
        # Input target size
#         if self.TARGET_RESIZE_MODE == "crop":
#             self.TARGET_SHAPE = np.array([self.TARGET_MIN_DIM, self.TARGET_MIN_DIM, 3])
#         else:
